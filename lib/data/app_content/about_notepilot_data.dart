...
class AboutNotePilotData {
  ...
  static const String appTagline = "A powerful offline-first notes and knowledge management application designed to help you organize ideas, research, documents, and references securely.";
  static const String versionBadge = "Version 1.0.0";
  static const String releaseDateBadge = "July 2026";
  static const String platformBadge = "Android";

  static const String shortDescription = "Create folders, write rich notes, attach book and video references, search instantly, export documents, and securely back up your data to Google Drive.";
  ...
  static final List<AboutFeatureData> features = [
    AboutFeatureData(
      ...
      desc: "Create unlimited folders with custom colors to organize your notes exactly the way you want.",
    ),
    AboutFeatureData(
      ...
      title: "Rich Notes",
      desc: "Create detailed notes with titles and descriptions. Notes are automatically saved while you work.",
    ),
    AboutFeatureData(
      ...
      desc: "Attach book references including:\n• Book Name\n• Author\n• Volume\n• Page Number\n• Line Number",
    ),
    AboutFeatureData(
    ...
    AboutFeatureData(
      ...
      title: "Move & Organize",
      desc: "Move folders or notes between directories.\nSupports:\n• Single move\n• Multi-selection move\n• Root directory move",
    ),
    AboutFeatureData(
      iconBg: const Color(0xFFEDE9F8),
      iconColor: const Color(0xFF6C5CE7),
    ...
    AboutFeatureData(
      ...
      desc: "Choose the appearance that best matches your preference.",
    ),
    AboutFeatureData(
      iconBg: const Color(0xFFFCE4EC),
      iconColor: const Color(0xFFAD1457),
      ...
      desc: "English interface (Left-to-Right)\nUrdu notes automatically displayed Right-to-Left.",
    ),
  ];

  // Info List
  static final List<AboutInfoData> information = [
    AboutInfoData(
      iconBg: const Color(0xFFEDE9F8),
      iconColor: const Color(0xFF6C5CE7),
  ...
  static const String rateAppDesc = "Rate us on Google Play and help other users discover NotePilot.";
  static const String rateAppButton = "Rate us";
  static const String rateAppUrl = "market://details?id=com.gmtechsoft.notepilot";
